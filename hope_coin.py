...
class BlockChain:
	...
	def replace_chain(self):
		...
		for node in network:
			...
			if response.status_code == 200 and max_length < response.json()["length"] and is_valid(response.json()["chain"]):
...
os.environ["FLASK_APP"] = "blockchain.py"
...
def mine_block():
	...
	blockchain.add_transaction(sender=node_address, receiver='Manideep', amount=10)
